...
public class ConnectivityInfoUtils {
     ...
     *
     * @param context
     * @param onConnectivityInfoUtilsListener Callback to notify the Connection state.
     */
    ...
    public static interface OnConnectivityInfoUtilsListener {
        ...
        /**
         * Method to notify that user connected with network
         */
        public void onConnectivityInfoUtilsNetworkConnected();

        /**
         * Method to notify that user dis-connected with network
         */
